...
const ContactSection: React.FC<SectionProps> = ({ visualizerRef }) => {
    ...
    const handleLinkHover = () => {
        visualizerRef.current?.updateParams({
             gridDensity: 8, // very sparse
             rotationSpeed: 0.05, // almost stopped
             colorShift: 0.1
        });
    };
            ...
            <div className="min-h-screen w-full flex flex-col items-center justify-center px-4">
                ...
                <div ref={formRef} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full">
                    ...
                    {[
                        ...
                        <div 
                            key={i} 
                            className="holographic cursor-pointer relative bg-slate-900/80 border-2 border-cyan-500/20 p-8 overflow-hidden group hover:border-cyan-400 transition-colors duration-300"
