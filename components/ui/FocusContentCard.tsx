...
interface FocusContent {
    ...
    summary: string;
    highlights: string[];
    phases: { label: string; detail: string; cue: string; }[];
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`relative z-10 ${expanded ? 'p-10 md:p-12' : 'p-7 md:p-8'} flex flex-col gap-6`}>
                    ...
                    {expanded ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-200">
                            {content.phases.slice(0, 2).map((phase) => (
                                <div key={phase.label} className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
