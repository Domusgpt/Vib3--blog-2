    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden bg-slate-950 text-white">
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-30 px-4 py-3 rounded-full bg-white/10 border border-white/20 text-sm font-semibold backdrop-blur hover:bg-white/20 transition"
            >
                Open Ops Dashboard
            </button>
