...
- `VITE_PUBLIC_BASE` controls the asset base. Default is `/Vib3--blog-2/` for Actions-driven deploys; `npm run build:pages` forces `./` so branch-hosted `/docs` builds load assets from `/docs/assets`.
